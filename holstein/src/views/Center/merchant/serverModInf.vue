<template>
                                ...
                                <tr class="ti-no-ng-animate ng-scope">
                                    ...
                                    <td  style="vertical-align: top;">
                                        <div ng-bind="authInfo.userType" class="ng-binding ng-scope">
                                            ...
                                            <div style="display:inline-block;margin-left:-392px;">{{this.$data.username}}（自动生成）</div>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="ti-no-ng-animate ng-scope">
            ...
            <el-form-item class="el-form-item el-form-item--small" style="width: 50%;margin-top:40px;">
                <div @click="submitForm('ruleForm1')" class="el-form-item__content" style="margin-left: 0px;">
                    <button type="button" class="el-button el-button--primary el-button--medium" style="">确认修改</button>
                                            ...
                                            <el-button ng-bind="authInfo.userType" class="ng-binding ng-scope" style="color:blue;border:none;margin-left:-500px;" slot="reference">修改密码</el-button>
                                        </el-popover>
                                    </td>
                                ...
                                <tr class="ti-no-ng-animate ng-scope">
                                    ...
                                    <td style="vertical-align: top">
                                        <div ng-bind="authInfo.acceptTime" class="ng-binding ng-scope">

                      
                                            <el-radio-group v-model="businessInf.acceptTime" style="margin-left:-392px;">
                                                <el-radio :label="1">全天</el-radio>
                                                <el-radio :label="2">仅工作日</el-radio>
                                              </el-radio-group>
                                        </div>
                                    </td>
                                ...
                                <tr class="ti-no-ng-animate ng-scope">
                                    <td class="ti-no-ng-animate ti-form-label ti-text-form-label ng-scope" style="vertical-align: top;">接单时间 </td>
                                    <td  style="vertical-align: top;">
                                ...
                                <tr class="ti-no-ng-animate ng-scope">
                                    ...
                                    <td  style="vertical-align: top;">
                                        ...
                                        <div ng-bind="authInfo.name" class="authInfoName ng-binding ng-scope" style="margin-left:-340px;">
                            ...
                            <el-form-item class="el-form-item is-required el-form-item--small" label="验证码" prop="code">
                                <div class="el-form-item__content" style="margin-left: 0px;">
                                    <div class="el-input el-input--small el-input--prefix">
                                        ...
                                        <input type="text" autocomplete="off" v-model="ruleForm2old.msgCode" placeholder="请输入验证码" class="el-input__inner verificationCode" style="width:280pxheight:32px;padding-top:8px;">
                            ...
                            <el-form-item class="el-form-item is-required el-form-item--small" label="验证码" prop="code">
                                <div class="el-form-item__content" style="margin-left: 0px;">
                                    <div class="el-input el-input--small el-input--prefix">
                                        ...
                                        <input type="text" autocomplete="off" v-model="ruleForm2new.code" placeholder="请输入验证码" class="el-input__inner verificationCode" style="width:280px;height:32px;padding-top:8px;">
                ...
                <el-button v-show="step3" style="margin-top: 12px;" @click="next()">下一步</el-button>
                                ...
                                <tr class="ti-no-ng-animate ng-scope">
                                    ...
                                    <td v-show="!wxbd"  style="vertical-align: top;">
                                        ...
                                        <div ng-bind="authInfo.authTime" class="ng-binding ng-scope" style="margin-left:-370px;">
                                            未绑定
                                            <el-popover
    placement="right"
    title="绑定微信"
    ...
    v-model="visibleChangewx">
                                ...
                                <el-form class="el-form login-form el-form--label-left" :model="ruleForm2bdwx" status-icon :rules="rules2bdwx" ref="ruleForm2bdwx" style="background-color:whitesmoke;">
...
<!--                                                    <span class="el-input__prefix">
    ...
    v-model="visibleChangezfb">
                                ...
                                <el-form class="el-form login-form el-form--label-left" :model="ruleForm2bdzfb" status-icon :rules="rules2bdwx" ref="ruleForm2bdzfb" style="background-color:whitesmoke;">
                                    <el-form-item class="el-form-item is-required el-form-item--small" label="手机" prop="usemobilername">
                                        <div class="el-form-item__content" style="margin-left: 0px;">
                                            <div class="el-input el-input--small el-input--prefix">
                                ...
                                <tr class="ti-no-ng-animate ng-scope ti-form-list">
                                    ...
                                    <td  style="vertical-align: top;"> 
                                        <div ng-bind="authInfo.authTime" class="ng-binding ng-scope">                                  
                                            <el-input type="textarea" style="margin-left:-40px" v-model="businessInf.intro" placeholder="请告诉我们您的喜好、专业知识或者其他你想展示的内容。（不低于150字）"></el-input>
        ...
        handleContImgPreview: function (file) {
            ...
            saveChangesInf(){
                this.$http.post('/api/register',{
                    ...
                    acceptTime:this.businessInf.acceptTime,
                }).then((res)=>{
                    var message = res.data.msg.message;
