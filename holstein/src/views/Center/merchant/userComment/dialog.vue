  ...
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" title="查看评论详情" width="50%">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="" style="padding:30px">
      ...
      <el-form-item label="服务评分：" prop="serviceScore">
        ...
        <div class="" v-else-if="form.isTraceableEvaluation === null">
          <el-rate allow-half=""
              v-model="form.serviceScore"
              show-text>
          </el-rate>
        </div>
        <div class="" v-else-if="form.isTraceableEvaluation === '1'">
          <el-rate allow-half="" disabled
              v-model="form.serviceScore"
              show-text>
          </el-rate>
      ...
      <div v-if="form.isTraceableEvaluation === '0'">
          <el-form ref="form0" :model="form">
                ...
                <el-form-item label="卖家回复图片内容：">
                    <div class="popoverConText dispalyFlex" style="background:red" >
                        <div>
                            <img :src="item.fileUrl" alt="" style="width:200px">
                        </div>
                        <div>
