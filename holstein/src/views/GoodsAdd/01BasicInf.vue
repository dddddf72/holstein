    ...
    <div class="home">
        ...
        <div class="merchantRegist">
            <div class="merchantRegistration">
                <div class="addTitle" style="float: right;">{{pageTitle}}</div>
                <div  class="addTitle" @click="goback()" >返回</div>
                                        ...
                                        <el-col :span="12">
                                            ...
                                            >
                                                <div
                                                    ...
                                                    style="margin-left: 130px"
                                                >
                                                    <el-select v-model="addform.returnable" placeholder="请选择商品是否可退货">
                                                        <el-option
                                                        v-for="item in returnableoptions"
                                                        :key="item.value" @change="changeReturnable"
                                                        :label="item.label"
                                                        :value="item.value">
                                                        </el-option>
                                                    </el-select>
                                        ...
                                        >
                                            <div class="el-form-item__content" style="">
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        2、请务必上传商品图片，默认第一张为封面图；图片最多上传19张，格式为jpg，jpge，png；
                                                    </div>
                                                    <div>
                                                        3、视频最多上传一个，格式为mp4，最大为200M
                                                    </div>
                                                </div>
                                            </div>
                                        </el-form-item>
                                    ...
                                    <el-col :span="24">
                                        ...
                                        >
                                                <el-upload class="avatar-uploader"
                                                    ...
                                                    :on-remove="handleContvideoRemove"
                                                    :before-upload="beforeUploadVideo"
                                                    :on-progress="uploadVideoProcess">
                                                    <video v-if="addform.Video && videoFlag == false" :src="getImgUrl(addform.Video)" class="videoBox" controls="controls">您的浏览器不支持视频播放</video>
                                                    <template v-else-if="!addform.Video && videoFlag == false">
                                                        <i class="el-icon-upload"></i>
                                                        <div class="el-upload__text">视频最多上传一个,格式为mp4</div>
                                                    </template>
                            ...
                            :data="pricesCustoms">
                                ...
                                <el-table-column label="基础">
                                    <template slot-scope="scope" >
                                        ...
                                        <el-row v-else-if="scope.row.title == '商品可接单量'">
                                            <el-input v-model="scope.row.oneValue" placeholder="请输入商品可接单量" type="number"></el-input>
                                        </el-row>
                    ...
                    <div class="stepsContent1">
                        <div style="margin-top: 20px;" >
                            <div class="alreadyAdded" v-if="faq.length >0">
                                ...
                                <div class="list"  v-for="(item,idx) in faq" :key="item.question+ '-only'">
                                    <div class="item" style="color: #303133;">
                                    ...
                                    <div class="item-con" v-show="item.show" style='color: rgb(133, 133, 133);'>{{item.answer}}</div>
                                </div>
                            </div>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            rulesadd: {
                ...
                returnable: [{ required: true, message: '请选择商品是否可退货', trigger: 'blur' }],
            //returnable: 0,//是否可退货，0否1是
    ...
    methods: {
        ...
        goback(){
            this.$router.push('/serviceProduct')
            setTimeout(function () {
        ...
        getDetail() {
            this.$http.get('/api/serviceProduct/' + this.id).then(res => {
                // this.addform = res.data.biz;
                    ...
                    this.addform.returnable = res.data.biz.returnable
        ...
        handleContImgRemove: function (file, fileList) {
            ...
            let link = file.url.replace('http://api.woniuskill.com', '')
        ...
        handleContvideoRemove: function (file, fileList) {
            console.log(file.url)
            let link = file.url.replace('http://api.woniuskill.com/api/uploadVideo', '')
            this.addform.videoUrl.forEach((item,idx) => {
                if (item.fileUrl == link) {
                    this.addform.videoUrl.splice(idx, 1)
                }
            })
        ...
        changeReturnable(returnable){
          console.log(returnable)
          this.addform.serviceSort = returnable
        },
        ...
        submitAdd() {
            let dt = {
                ...
                faq: this.faq,
                returnable: this.addform.returnable,
