            ...
            <div class="merchantRegistration">
                <div class="roblox" style="">
                    <div class="gfxSimi checkDiv">
                        ...
                        <div class="gfxPayOne" @click="goOnCheck" style="cursor:pointer">继续结账</div>
                    </div>
                </div>
                <div class="designLeft">
                    ...
                    <div class="imageDesc" style="width:715px;margin:30px 0">
                        <div style="width:335px;height:195px; margin-right:20px" v-if="initData.files && initData.files.length >0 ">
                            <img :src="getImgUrl(initData.files[0].fileUrl)" alt="" style="width:335px;height:195px">
                        ...
                        <div class="">
                            ...
                            <div class="" style="cursor:pointer" @click="showCon = !showCon">
                    ...
                    <div v-if="initData.expressDeliveries !==null">
                      <div class="" v-if="initData.expressDeliveries.length>0 || initData.addtoServices.length > 0">
                          ...
                          <div class="checkDiv">
                              <template v-if="initData.expressDeliveries.length > 0">
                                  <p style="font-size:16px;margin-top:20px">特快交付：</p>
    ...
    computed: {
        ...
        otherTotal() {
            ...
            if (this.checkList.length > 0) {
                ...
                // if(this.initData.addtoServices !==null){
            ...
            if (this.checkList2.length > 0) {
              if(this.initData.expressDeliveries !==null){
            ...
            this.$http.post('/api/order/affirm',{
                ...
                this.$router.push({
                    ...
                    query: {
                        ...
                        id: res.data.biz.orderNo,//订单号
                        orderId:res.data.biz.id,//订单Id
