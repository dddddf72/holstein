                    ...
                    <div class="" style="padding:20px;">
                        ...
                        <table cellspacing="0" cellpadding="0" style="width: 1238px;">
                            ...
                            <tr class="boldSimi" style="">
                                <td style="">服务商信息</td>
                                <!--<tdv-for="tdin tableTh" :key="th" style="height:60px;line-height:60px;font-size:16px">
                                    {{th.title}}
                                </tdv-for=> -->
                                <td>个人简介</td>
                                <td>技能标签</td>
                                ...
                                <!-- <tr v-for="index in dataList" :key="index">
                                    <td rowspan="1">
                                        为您的fu
                                    </td>
                                    <td rowspan="1" class="el-table_1_column_1 is-leaf"><div class="cell">{{index}}</div></td>
                                    <td v-for="item in dataList" :key="item">{{item.c1}}</td>
                                </tr> -->
                                    <tr style="">
                                        <td >
