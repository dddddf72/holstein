                    ...
                    <el-tab-pane label="商品收藏列表" name="first">
                        <div>
                            ...
                            <el-table :data="tableData">
                                <el-table-column prop="index+1" label="序号"></el-table-column>
...
export default {
    ...
    async mounted() {
            var res = await GoodsHttp.serviceCollect(this.queryData.serviceId,this.queryData.serviceName,1);
    ...
    methods: {
        async  toQuery() {
			var resa = await GoodsHttp.serviceCollect(this.queryData.serviceId,this.queryData.serviceName,1);
