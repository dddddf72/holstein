                ...
                <div class="pwdResetCenter">
                    <el-form class="el-form login-form el-form--label-left" :model="ruleForm1" status-icon :rules="rules1" ref="ruleForm1" style="width:390px;margin:0 auto">
                        ...
                        <el-form-item class="el-form-item is-required el-form-item--small" label="手机" prop="username">
                            <div class="el-form-item__content" style="margin-left: 0px;">
                                <div class="el-input el-input--small el-input--prefix">
                                    <input type="text" v-model="ruleForm1.username" autocomplete="off" placeholder="手机" class="el-input__inner" style="display:inline-block">
                                </div>
                            </div>
                        </el-form-item>
                        <el-form-item class="el-form-item is-required el-form-item--small" label="新密码" prop="newPass">
                            <div class="el-form-item__content" style="margin-left: 0px;">
                                <div class="el-input el-input--small el-input--prefix">
                                    <input type="password" v-model="ruleForm1.newPass" autocomplete="off" placeholder="请输入新密码" class="el-input__inner" style="display:inline-block">
                                </div>
                            </div>
                        </el-form-item>
                        <el-form-item class="el-form-item is-required el-form-item--small" label="确认新密码" prop="confirmPass">
                            <div class="el-form-item__content" style="margin-left: 0px;">
                                <div class="el-input el-input--small el-input--prefix">
                                    <input type="password" v-model="ruleForm1.confirmPass" autocomplete="off" placeholder="请再次输入新密码" class="el-input__inner" style="display:inline-block">
                                </div>
                            </div>
                        </el-form-item>
